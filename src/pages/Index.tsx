                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-0">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 mb-1 sm:mb-1 min-w-0">
                              <h3 className="text-base sm:text-xl font-bold text-gray-800 min-w-0 truncate md:overflow-visible md:whitespace-normal lg-mid:overflow-hidden lg-mid:text-ellipsis lg-mid:whitespace-nowrap">{project.name}</h3>
                            ...
                            <div className="flex flex-row flex-nowrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600 mb-1 sm:mb-0 min-w-0 overflow-hidden">
                              <span className="flex items-center gap-1 min-w-0 flex-1 overflow-hidden">
                                ...
                                <span className="truncate md:overflow-visible md:whitespace-normal lg-mid:overflow-hidden lg-mid:text-ellipsis lg-mid:whitespace-nowrap">{project.client}</span>
                              </span>
                              <span className="flex items-center gap-1 min-w-0 flex-1 overflow-hidden">
                                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="truncate md:overflow-visible md:whitespace-normal lg-mid:overflow-hidden lg-mid:text-ellipsis lg-mid:whitespace-nowrap">{project.location}</span>
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-blue-50">
                        <div className="grid grid-cols-2 gap-4 text-xs sm:text-sm min-w-0">
                          <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 min-w-0">
                            ...
                            <p className="font-semibold text-gray-800 mt-1 min-w-0 truncate md:overflow-visible md:whitespace-normal lg-mid:overflow-hidden lg-mid:text-ellipsis lg-mid:whitespace-nowrap text-xs sm:text-sm" title={project.manager}>{project.manager}</p>
                          </div>
                          <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 min-w-0">
                            <span className="text-gray-500 text-[10px] sm:text-xs font-medium uppercase tracking-wide">PO Number</span>
                            <p className="font-semibold text-gray-800 mt-1 min-w-0 truncate md:overflow-visible md:whitespace-normal lg-mid:overflow-hidden lg-mid:text-ellipsis lg-mid:whitespace-nowrap text-xs sm:text-sm" title={project.poNumber}>{project.poNumber}</p>
                          </div>
                          <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 min-w-0">
